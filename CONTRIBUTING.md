...
`cloud-itonami-isco-7531` accepts contributions to the OSS actor, policy tests,
...
- Do not commit real artisan, workshop or operator data, credentials or operating
  documents.
- Keep production writes and disclosures behind StitchCoordGovernor.
...
- Never widen the closed op-allowlist to include a
  garment-construction-execution-finalization op, a
